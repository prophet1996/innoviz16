...
public class GoogleLogin extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            //get user email, name, etc information
    ...
    private void updateUI(boolean signedIn) {
        if (signedIn) {
            Intent zalonin = new Intent(this, MainActivity.class);
            startActivity(zalonin);
            finish();
    ...
    // [START signIn]
    private void signIn() {
        //phone no. dialog fragment to be added here **********************Look Here*****************************
